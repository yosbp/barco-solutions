...
const initFullNavbarMenu = () => {
  ...
  let logoChan = document.querySelector(".topnav.dark .logo img");
  let menuIcon = document.querySelector(".topnav .menu-icon");
  let menuText = document.querySelector(".topnav .menu-icon .text");
